...
Route::middleware(['auth'])->group(function () {
    ...
    // Ruta reports maintenances printers PDF
...
//SKMS
Route::post('skms/store', 'SkmsController@store')->name('skms.store')
    ->middleware('can:permission:skms.create');
Route::get('skms', 'SkmsController@index')->name('skms.index')
    ->middleware('can:permission:skms.index');
Route::get('skms/create', 'SkmsController@create')->name('skms.create')
    ->middleware('can:permission:skms.create');
Route::put('skms/{id}', 'SkmsController@update')->name('skms.update')
    ->middleware('can:permission:skms.edit');
Route::get('skms/{id}', 'SkmsController@show')->name('skms.show')
    ->middleware('can:permission:skms.show');
Route::delete('skms/{id}', 'SkmsController@destroy')->name('skms.destroy')
    ->middleware('can:permission:skms.destroy');
Route::get('skms/{id}/edit', 'SkmsController@edit')->name('skms.edit')
    ->middleware('can:permission:skms.edit');
