                ...
                <div class="card shadow mb-4">
                    <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button"
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">
                            ...
                            Equipo de computo: {{ $historyMaintenance->computer->id }} <br>
                            Placa: {{ $historyMaintenance->computer->license_plate }}
                            <small>{{ $historyMaintenance->computer->servicetag }}, </small>
                        </h6>
                    </a>
                    <div class="collapse show" id="collapseCardExample">
                        <div class="card-body">
                            ...
                            <strong>{{ $historyMaintenance->computer->updated_at->diffForHumans() }}</strong>
                        </div>
                    </div>
                </div>
