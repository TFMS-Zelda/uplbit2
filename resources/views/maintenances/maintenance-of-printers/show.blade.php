                ...
                <div class="card shadow mb-4">
                    <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button"
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">
                            ...
                            Equipo de computo: {{ $historyMaintenance->printer->id }} <br>
                            Placa: {{ $historyMaintenance->printer->license_plate }}
                            <small>{{ $historyMaintenance->printer->servicetag }}, </small>
                        </h6>
                    </a>
                    <div class="collapse show" id="collapseCardExample">
                        <div class="card-body">
                            ...
                            <strong>{{ $historyMaintenance->printer->updated_at->diffForHumans() }}</strong>
                        </div>
                    </div>
                </div>
