...
class DocumentController extends Controller
{
    public function checkLists()
    {
        ...
        return view('documents.checklists.index', compact('employees'));
    }
    ...
    public function peaceSaves()
    {
        $employees = \App\Employee::get();
        return view('documents.peace-&-saves.index', compact('employees'));
    }
    ...
    public function downloadPeaceSave(Employee $employee)
    {
        ...
        $pdf = \PDF::loadView('reports.peace-&-saves.download', [
            'employee' => $employee,
            'computers' => $computers,
            'computersCount' => $computersCount,
            'tablets' => $tablets,
