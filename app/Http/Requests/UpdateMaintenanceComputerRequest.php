...
class UpdateMaintenanceComputerRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'attachments' => "max:1024|mimes:pdf|nullable|unique:maintenance_computers,attachments,{$this->historyMaintenance->id}",
